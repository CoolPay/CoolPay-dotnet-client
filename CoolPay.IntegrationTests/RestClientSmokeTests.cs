...
namespace CoolPay.IntegrationTests
{
    ...
    public class RestClientSmokeTests
    {
        ...
        {
			var sut = new PingExample(CpConfig.Username, CpConfig.Password);
            var result = sut.Ping();
		...
		{
			var sut = new MerchantExample(CpConfig.ApiKey);
        ...
        {
            var sut = new MerchantExample(CpConfig.Username, CpConfig.Password);
