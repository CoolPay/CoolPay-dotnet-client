...
using CoolPay.Parameters;
using CoolPay.Util;

namespace CoolPay
{
	public abstract class CoolPayRestClient
	{
		protected RestClient Client { get; set; }

		public const string BASE_URL = "https://api.coolpay.com/";

		public CoolPayRestClient (string username, string password)
		{
			...
			Client = new RestClient (BASE_URL) {
				...
				UserAgent = "CoolPay .Net client"
            };
		}

		public CoolPayRestClient (string apikey) : this(string.Empty, apikey)
		{}
